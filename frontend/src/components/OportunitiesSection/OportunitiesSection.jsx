                    ...
                    <div ref={cardRef} className="bg-white rounded-xl md:rounded-2xl shadow-2xl overflow-hidden scroll-reveal animate-fadeInUp hover-lift">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 min-h-[500px] md:min-h-[600px] lg:min-h-[700px] p-4 md:p-6 lg:p-8">
                            ...
                            <div ref={textRef} className="p-6 md:p-8 lg:p-12 xl:p-24 flex flex-col justify-center scroll-reveal animate-slideInLeft delay-200">
                                <div className="">
                                    <div className='flex'>
                                        <h2 className="font-work-sans text-2xl md:text-2xl lg:text-4xl xl:text-4xl font-bold text-gray-900 mb-4 md:mb-6 lg:mb-8">

                                            🏠 Inversiones inteligentes en propiedades españolas
                                        </h2></div>
                                    <p className="text-gray-600 mb-6 md:mb-8 lg:mb-10 leading-relaxed text-md md:text-base lg:text-lg">
                                ...
                                <div className="space-y-3 md:space-y-4 lg:space-y-5 mb-6 md:mb-8 lg:mb-10">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-gray-700 text-md md:text-base lg:text-lg font-bold">Inversiones desde 100.000 €</span>
                                    </div>
                                    <div className="flex items-center">
                                        <span className="text-green-500 mr-3 md:mr-4 text-lg md:text-xl">✓</span>
                                        <span className="text-gray-700 text-md md:text-base lg:text-lg font-bold">Rentabilidad desde el 7% anual</span>
                                    </div>
                                    <div className="flex items-center">
                                        <span className="text-green-500 mr-3 md:mr-4 text-lg md:text-xl">✓</span>
                                        <span className="text-gray-700 text-md md:text-base lg:text-lg font-bold">Gestión incluida (ideal para Airbnb o alquiler estable)</span>
                                    </div>
                                    <div className="flex items-center">
                                        <span className="text-green-500 mr-3 md:mr-4 text-lg md:text-xl mb-4">✓</span>
                                        <span className="text-gray-700 text-md md:text-base lg:text-lg font-bold">Acompañamiento legal y fiscal completo</span>
                                    </div>
                                    <button onClick={handleScrollToProperties} className="cursor-pointer border border-[#0E0E0E] text-[#0E0E0E] font-bold px-4 md:px-6 py-3 md:py-4 rounded text-md md:text-sm hover:bg-[#0E0E0E] hover:text-white transition-colors flex items-center justify-center md:justify-start w-full md:w-auto hover-lift animate-buttonPulse">
                                        Ver Propiedades
